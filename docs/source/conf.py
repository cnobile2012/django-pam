# -*- coding: utf-8 -*-
#
# Django PAM documentation build configuration file, created by
...
project = 'Django PAM'
copyright = '{:d}, Carl J. Nobile'.format(datetime.datetime.now().year)
...
htmlhelp_basename = 'DjangoPAMdoc'
...
latex_documents = [
    (master_doc, 'DjangoPAM.tex', 'Django PAM Documentation',
     'Carl J. Nobile', 'manual'),
]
...
man_pages = [
    (master_doc, 'djangopam', 'Django PAM Documentation',
     [author], 1)
]
